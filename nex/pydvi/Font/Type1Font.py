...
class Type1Font(Font):
    ...
    def __init__(self, font_manager, font_id, name):
        ...
        if freetype.FT_ENCODING_ADOBE_CUSTOM in encodings:
            ...
            raise NameError(
                "Font %s doesn't have an Adobe encoding" % (self.name))
    ...
    def _find_afm(self):
        ...
        if afm_file is None:
            raise NameError(
                "AFM file was not found for font {}".format(self.name))
        else:
...
class FontSize(object):
    ...
    def load_glyph(self, glyph_index, lcd=False):
        ...
        # stride / number of bytes taken by one bitmap row
        ...
        # the top border of the glyph bitmap. This distance is positive for
        # upwards y!
...
class FontMetrics(object):
    ...
    * Linegap
    ...
    def __init__(self, font_size):
        ...
        self.linegap = self.height - self.ascender + \
            self.descender  # Fixme: check
