...
\outer\def\newif#1{
  ...
  \escapechar=\count@
} % the condition starts out false
...
% \def\shilly{tut}
% \expandafter\def\shilly{hoho}
% % \expandafter\expandafter1r
% % \expandafter
% % \expandafter
% % \expandafter
% % \def\@if#1{true}
...
\ifnum\count22<2 \ifnum1<2 b\else c\fi \else y\fi
% \ifnum\count22<2\ifnum2>1\message{h}\fi\else\message{y}\fi
