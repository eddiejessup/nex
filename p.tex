...
\def\alloc@#1#2#3#4#5{\global\advance\count1#1by\@ne
  ...
  % \immediate\write\m@ne{\string#5=\string#2\the\allocationnumber}
}
...
% \let\elsy=\else
% \def\elsi{\insc@unt\else}
% \ifnum\count11<\insc@unt\else\errmessage{No room for a new dimen}\fi
% \ifnum\count11<\elsi\errmessage{No room for a new dimen}\fi

\alloc@1\dimen\dimendef\insc@unt\maxdimen

% % % \advance\count11by1
% % % \dimendef\maxdimen=\allocationnumber